...
function catalogMore() {
  var more = document.querySelectorAll('.catalog-item__link'),
...
/* harmony default export */ __webpack_exports__["default"] = (catalogMore);
...
function forms() {
  ...
  function createErrorMessage(elem, form) {
    var name = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : elem.getAttribute('name');
    ...
    form.addEventListener('submit', function (e) {
      ...
      elems.forEach(function (elem) {
        if (elem.tagName !== 'BUTTON') {
          var rulesList = elem.dataset.rule.split(' ');
      ...
      request.open('POST', 'server.php'); // request.setRequestHeader('Content-type', 'application/json');
...
function modal() {
  var btnsConsultation = document.querySelectorAll('[data-modal="consultation"]'),
  ...
  btnsConsultation.forEach(function (btn) {
  ...
  btnsOrder.forEach(function (btn, i) {
    btn.addEventListener('click', function () {
      overlay.style.display = 'block';
...
function slider() {
  var slidesWrapper = document.querySelector('.slider__slides'),
  ...
  function toggleDots() {
    ...
    dots.forEach(function (dot) {
      return dot.classList.remove('slider__dot_active');
    });
...
function tabs() {
  ...
  function toggleActive() {
    tabs.forEach(function (tab) {
      return tab.classList.remove('catalog__tab_active');
    });
    contants.forEach(function (contant) {
      return contant.classList.remove('catalog__content_active');
    });
...
/* harmony import */ var _modules_catalogMore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/catalogMore */ "./src/js/modules/catalogMore.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_catalogMore__WEBPACK_IMPORTED_MODULE_2__["default"])();
